...
from _MClim_Standalone_Surf7.MClim_normFunc import f_read_hcd
from _MClim_Standalone_Surf7.MClim_njitFunc import f_iterate_throug_time
...
def FiniteDiffDempsey(AirTempFile, AirTempFolder, latitude, longitude, daylight_saving, UTC, openmonth,
    ...
    Prec_in_an_avg, yrstart, FreezeThaw = f_read_hcd(AirTempFolder, AirTempFile, Imonth_start, tdesign, ClimDataType)
    ...
    """
    Tsubdum_M = []      # As the MECPA does not need the quantiles, return empty list.

    # Returning section.
    return Tsubdum_M, MAAT_F, Yr, Mo, Tpave_mek_F, Tsurf_mek_F, Prec_in, FreezeIndex, Prec_in_an_avg, \
           yrstart, Dy, Hr, Tair_F, PHum, FreezeThaw / tdesign
